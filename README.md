...
> 첫 실행 시 `database/bms.db`가 자동 생성되고 스키마 초기화 + 샘플 데이터(공장, 모델, 설정값)가 삽입됩니다.
...
> `DataSeeder.java`가 DB 첫 초기화 시 자동으로 삽입합니다.
...
- **공장**: 청림, 은하, 백운, 단풍, 태양, 한빛 (6개)
- **모델**: 볼트 S, 노바 X5/X9/GT60/GT70e, 시티버스 E, 벡터 E3/E4/E6/E9/V5/밴 EV (12개)
- **수출국**: 한국, 미국, 독일, 영국, 프랑스, 일본, 중국, 인도, 호주, 캐나다
